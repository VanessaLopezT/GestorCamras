...
import com.example.gestorcamaras.dto.ImagenDTO;
...
import com.example.gestorcamaras.service.ImagenService;

import com.example.gestorcamaras.service.ProcesadorImagenService;
...
public class ImagenController {
    ...
    private Imagen convertirAEntidad(ImagenDTO dto) {
        ...
        if (dto.getCamaraId() != null) {
            var camara = new com.example.gestorcamaras.model.Camara();
