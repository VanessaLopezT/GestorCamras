package com.example.gestorcamaras;

import com.example.gestorcamaras.Escritorio.LoginFrame;
import com.example.gestorcamaras.Escritorio.ServidorUI;
...
@ComponentScan({
    "com.example.gestorcamaras",
    "com.example.gestorcamaras.config",
    "com.example.gestorcamaras.security"
})
@EnableJpaRepositories({"com.example.gestorcamaras.repository", "com.example.gestorcamaras.pool"})
@EntityScan("com.example.gestorcamaras.model")
public class GestorCamarasApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (!MODO_CLIENTE.equals(modo)) {
                ...
                SpringApplication app = new SpringApplication(GestorCamarasApplication.class);
    ...
    private static void iniciarInterfazServidor() {
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                Class.forName("com.example.gestorcamaras.Escritorio.ServidorUI");
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.setProperty("gestorcamaras.server.host", host);
                    System.setProperty("gestorcamaras.server.port", String.valueOf(port));
    ...
    private static void mostrarAyuda() {
        ...
        mensaje.append("Uso: java -jar gestor-camaras.jar [MODO] [IP_SERVIDOR]\n\n");
        ...
        mensaje.append("  java -jar gestor-camaras.jar                     # Muestra diálogo de selección\n");
        mensaje.append("  java -jar gestor-camaras.jar --servidor          # Solo servidor\n");
        mensaje.append("  java -jar gestor-camaras.jar --cliente 192.168.1.100  # Solo cliente, conectado al servidor en 192.168.1.100\n");
