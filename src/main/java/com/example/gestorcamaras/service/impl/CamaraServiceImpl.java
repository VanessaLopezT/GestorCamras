package com.example.gestorcamaras.service.impl;

import com.example.gestorcamaras.model.Camara;
import com.example.gestorcamaras.model.Equipo;
import com.example.gestorcamaras.repository.CamaraRepository;
import com.example.gestorcamaras.repository.EquipoRepository;
import com.example.gestorcamaras.repository.UbicacionRepository;
import com.example.gestorcamaras.repository.UsuarioRepository;
import com.example.gestorcamaras.service.CamaraService;
import com.example.gestorcamaras.service.GeocodingService;
...
public class CamaraServiceImpl implements CamaraService {
    ...
    public Camara toEntity(CamaraDTO dto) {
        ...
        if (dto.getUbicacionId() != null) {
            ...
            com.example.gestorcamaras.model.Ubicacion ubicacion = new com.example.gestorcamaras.model.Ubicacion();
                    ...
                    new Thread(() -> {
                        try {
                            ...
                            if (camaraActualizada != null && camaraActualizada.getUbicacion() != null) {
                                com.example.gestorcamaras.model.Ubicacion ubicacion = camaraActualizada.getUbicacion();
