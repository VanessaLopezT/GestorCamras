package com.example.gestorcamaras.Escritorio.controller;

import com.example.gestorcamaras.Escritorio.service.ClienteCamaraService;
import com.example.gestorcamaras.Escritorio.service.ClienteEquipoService;
import com.example.gestorcamaras.Escritorio.service.FileUploadService;
import java.io.File;
...
import com.example.gestorcamaras.Escritorio.websocket.StompClient;
...
public class ClienteSwingController {
    ...
    private com.example.gestorcamaras.service.IArchivoMultimediaService archivoMultimediaService;
    private com.example.gestorcamaras.service.CamaraService camaraServiceFilter;
    
    // Método para obtener el servicio de archivos multimedia
    public com.example.gestorcamaras.service.IArchivoMultimediaService getArchivoMultimediaService() {
        if (archivoMultimediaService == null) {
            // Crear una instancia del servicio de archivos multimedia
            archivoMultimediaService = new com.example.gestorcamaras.Escritorio.service.ClienteArchivoMultimediaService(
                servidorUrl, 
                cookieSesion,
                this::log
            );
    ...
    public com.example.gestorcamaras.service.CamaraService getCamaraService() {
        if (camaraServiceFilter == null) {
            // Crear una instancia del servicio de cámaras
            camaraServiceFilter = new com.example.gestorcamaras.Escritorio.service.ClienteCamaraServiceImpl(
                servidorUrl, 
                cookieSesion,
                this::log
            );
